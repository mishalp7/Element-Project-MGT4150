# allows us to access the random and sleep functions
import random
...
# display welcome and rules text
print("Welcome to the battle of the elements! Choose your element and see if you are the avatar!\nYou have five "
      "options as to what bender you can to be: "
      "Waterbender, Earthbender, Firebender, Airbender, or Lightningbender.\n")
sleep(4)
...
while playAgain:
    ...
    # make sure the users selection is valid
    ...
    # don't let the user choose the same bender three times in a row
    if countWater == 3:
    ...
    if correctInput is True:
        ...
        # give the user output depending on if they won or not and what they choose
        if win is True:
            if userSelect == "Waterbender" and compSelect == "Firebender":
                print(
                    "Your defensive waterbending snuffs any attacks from the Firebender, giving you an opening to attack against a defenseless opponent.")
            elif userSelect == "Waterbender" and compSelect == "Airbender":
                print(
                    "Due to air containing water, the Airbenders offensive and defensive attempts only act to provide an avenue to attack.")
            elif userSelect == "Firebender" and compSelect == "Lightningbender":
                print(
                    "Due to your diligent studies in Firebending and the movements of Waterbenders, you are able to redirect any lightning sent your way and add even more inertia to it.")
            elif userSelect == "Firebender" and compSelect == "Airbender":
                print(
                    "The Airbender has only managed to supply your flames with more oxygen, increasing your offensive abilities.")
            elif userSelect == "Earthbender" and compSelect == "Firebender":
                print(
                    "You understand that Firebenders only have offensive abilities, so by using your strong defense to nullify their attacks, their only option is to surrender.")
            elif userSelect == "Earthbender" and compSelect == "Waterbender":
                print(
                    "Your strong defense has managed to block all attacks, forcing the waterbender to be on the defensive and eventually overwhelming them.")
            elif userSelect == "Airbender" and compSelect == "Earthbender":
                print(
                    "No matter their efforts the Earthbender is unable to overwhelm your ability to divert their attacks.")
            elif userSelect == "Airbender" and compSelect == "Lightningbender":
                print(
                    "Using your knowledge of lightning, you understand that your opponent will be unable to produce enough static friction from with air by pulling the air away from them.")
            elif userSelect == "Lightningbender" and compSelect == "Earthbender":
                print(
                    "Your knowledge of the fact that Earthbenders must have a strong connection to the ground continuously in order to bend, making them act as a ground to your lightning.")
            elif userSelect == "Lightningbender" and compSelect == "Waterbender":
                print(
                    "While a Waterbender is a formidable opponent all around, your lightning will pass through any of their water-based attacks or defensive moves.")
        elif win is False:
            if compSelect == "Waterbender" and userSelect == "Firebender":
                ...
                print(
                    "While airbending is very versatile, the Waterbender is capable of attacking you with the water content in the air you bend.")
                ...
                print(
                    "The fire you have bended was blocked by the strong defense of the Earthbender, resulting in your offensive abilities being insufficient.")
            elif compSelect == "Earthbender" and userSelect == "Waterbender":
                print(
                    "The water you have bended was blocked by the Earthbender, resulting in your bending being nulled.")
                ...
                print(
                    "The Airbender has used airflow to affect the polarity and static friction in the air, resulting in you being unable to bend lightning.")
            elif compSelect == "Lightningbender" and userSelect == "Earthbender":
                print(
                    "Due to the earth you use acting as a ground for the lightning, your earthbending has only acted to provide a pathway for the electricity to reach you.")
    ...
    # give rude output if user wins or loses repeatedly
